...
{
    public class NormalDashStrategy : IDashStrategy
    {
        public NormalDashStrategy(JumpController jumpController)
        {
        ...
        public bool Dash()
        {
            ...
            {
                JumpController.playerRb.position = Vector2.MoveTowards(JumpController.playerRb.position, JumpController.hangPosition, Time.deltaTime * JumpController.jumpForce);
            }
